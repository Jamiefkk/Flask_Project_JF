...
def show(id):
    ...
    visit_status = visits_country_repository.select_all_from_country_for_user_1(id)
    return render_template("countries/show.html", country=country, cities=cities, attractions=attractions, visits = visits, visit_status=visit_status)
...
@visit_countries_blueprint.route("/countries/<id>/visited-none", methods=["POST"])
def mark_none(id):
